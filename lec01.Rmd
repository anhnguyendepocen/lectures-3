...
* The project will have three checkpoints: 
    1. PC 1 will be due __Thursday, January 25__, 
    2. PC 2 is due __Thursday, March 8__, 
    3. PC 3 is due on __Monday, April 30__. 
* All are to be uploaded to your repo by 11:59pm on those dates. 
* See the [project](https//stats-432sp2018.github.io/project.html) page for detailed requirements.
...
* The second exam will be available __Friday, April 13__ for submission by __Friday, April 20__. 
...
<p align=center>
![This is why](http://www.phdcomics.com/comics/archive/phd101212s.gif)
</p>
...
* We will use another service called [Slack](http://stats-432sp2018.slack.com/) for communication
* It is also free
...
* Go to https://github.com/STATS-432Sp2018/class-roster

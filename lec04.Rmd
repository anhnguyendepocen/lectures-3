...
Write code which draws a sample form the population given by this model.
...
\[
\begin{aligned}
\mathbb{E}\left[(Y-f(X))^2\right] &= \mathbb{E}\left[\mathbb{E}\left[(Y-f(X))^2 \ \vert\  X\right]\right]\\
  &= \mathbb{E}\left[\mathrm{Var}\left[Y\ \vert\  X\right] + \mathbb{E}\left[(Y-f(X)) \ \vert\  X\right]^2\right]\\
  &= \mathbb{E}\left[\mathrm{Var}\left[Y\ \vert\  X\right]\right] + \mathbb{E}\left[\mathbb{E}\left[(Y-f(X)) \ \vert\  X\right]^2\right]\\
\end{aligned}
\]
